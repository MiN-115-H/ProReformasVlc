...
// Permite saber si el banner está visible para ajustar el FAB
const appDownloadBannerVisible = ref(false);

function handleBannerVisibility(visible) {
  appDownloadBannerVisible.value = visible;
}
...
<template>
  <div class="min-h-screen flex flex-col bg-zinc-50 text-zinc-800">
    <AppDownloadBanner v-if="!useMinimalLayout" @visibility="handleBannerVisibility" />
    ...
    <a
      ...
      :class="['whatsapp-fab', appDownloadBannerVisible ? 'whatsapp-fab--with-banner' : '']"
    >
